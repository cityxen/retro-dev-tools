///////////////////////////////////////////////////////////////
// FujiNet Functions - Commodore 16 / Plus-4
// By Deadline / CityXen
//
// FujiNet connects via the C16/Plus-4 IEC serial bus.
// The KERNAL jump table ($FF81-$FFF3) is compatible with C64.
// FujiNet appears as a standard CBM serial device (default: 8).
// URL format for network files: FJ:HTTP://hostname/path
//
// Note: C16 has no VIC-II SPRITE_ENABLE register.
// Sprite disable/restore around KERNAL LOAD is omitted.
//
...
///////////////////////////////////////////////////////////////
// fj_detect_fujinet: open error channel, scan for "fujinet" in status
