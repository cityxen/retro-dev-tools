//////////////////////////////////////////////////////////////////
// CITYXEN COMMODORE 16 / PLUS-4 LIBRARY — Core print routines
//
// https://github.com/cityxen/Commodore16_Programming
// https://linktr.ee/cityxen
//
// C16/Plus-4 screen: 40 columns × 25 rows.  PETSCII output via KERNAL_CHROUT.
//
...
// x = column (0-39), y = row (0-24) for C16/Plus-4.
.macro PrintPlot(x,y) {
    ldx #y
    ldy #x
    clc
...
pr1:
    ...
    lda TED_COLOR_BG        // use TED background color as reference
    and #$0f
    cmp CURSOR_COLOR
    bne !+
    inc CURSOR_COLOR
