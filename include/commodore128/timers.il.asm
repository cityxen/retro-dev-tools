...
irq_timer_to_table:
.byte 10,25,30,60,120,200,50,55,60,65,70,75,15,16,17,20 // timer timeouts
irq_timer_tr_table:
...
!:
	...
	// Chain to C128 KERNAL IRQ handler (keyboard scan, TOD clock).
	// On C128 this is KERNAL_IRQ_ENTRY ($FA65), not C64's $EA31.
	jmp KERNAL_IRQ_ENTRY
