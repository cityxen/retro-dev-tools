//////////////////////////////////////////////////////////////////
// CITYXEN COMMODORE VIC-20 LIBRARY — Calculate screen position
//
...
//
// VIC-20: 22 columns per row (add $16 per row, not $28).
//////////////////////////////////////////////////////////////////
...
!csp_lp_i:
    ...
    jmp !csp_lp-
!csp_lp:
    cpy #$00                // add Y rows × 22 to pointer
!csp_lp:
    beq !csp_lp+
    lda zp_ptr_screen_lo
    clc
    adc #$16                // 22 ($16) columns per row
    sta zp_ptr_screen_lo
    lda zp_ptr_color_lo
    clc
    adc #$16
...
addto_screen_pos:
    lda zp_ptr_screen_lo
    clc
    adc #$16                // advance by one row (22 bytes)
    sta zp_ptr_screen_lo
    bcc !asp_exit+
    inc zp_ptr_screen_hi
!asp_exit:
