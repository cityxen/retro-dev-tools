//////////////////////////////////////////////////////////////////
// CITYXEN COMMODORE VIC-20 LIBRARY — Software Timer System
//
// https://github.com/cityxen/CommodoreVIC20_Programming
// https://linktr.ee/cityxen
//
// 16 software timers driven by the 60Hz hardware IRQ.
// Installs a custom handler at $0314/$0315 (same vector as C64).
// At end of IRQ, jumps to KERNAL_IRQ_ENTRY ($EABF) for KERNAL
...
!:
    ...
    jmp KERNAL_IRQ_ENTRY    // $EABF — VIC-20 KERNAL IRQ continuation
