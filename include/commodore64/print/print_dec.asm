...
// Note: clc+adc #$30 converts a 0-9 byte to its screen-code digit ($30-$39).
// Old library used adc #$2f and relied on carry being set from a preceding cmp;
// fixed here to be carry-independent.
