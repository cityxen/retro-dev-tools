///////////////////////////////////////////////////////////////
// FujiNet Functions - Commodore PET
// By Deadline / CityXen
//
// FujiNet connects to the PET via the IEEE-488 (GPIB) bus,
// the same bus used by CBM disk drives (4040, 8050, etc.).
// The KERNAL file API ($FF81-$FFF3) is bus-transparent —
// the same SETNAM/SETLFS/OPEN/LOAD calls work over IEEE-488.
// FujiNet appears as a standard CBM device (default: 8).
// URL format for network files: FJ:HTTP://hostname/path
//
// Note: PET has no VIC-II hardware sprites.
// FJHS_DRAW uses character-mode text rendering only.
//
...
///////////////////////////////////////////////////////////////
// fj_detect_fujinet: open IEEE-488 error channel,
//                    scan status string for "fujinet"
...
fj_det_loop:
    ...
    bne fj_det_next
    lda fj_detect_check
    cmp #'F'                // PET PETSCII is uppercase only
    bne fj_det_next
    lda #1
    sta fj_detected
fj_det_next:
...
///////////////////////////////////////////////////////////////
// URL tables (PET PETSCII — uppercase only)
.encoding "petscii_mixed"
...
///////////////////////////////////////////////////////////////
// FJHS_API_LOAD: KERNAL LOAD URL into top-10 table
FJHS_API_LOAD:
    lda #$01
    ldx fj_drive_number
    ldy #$00
...
///////////////////////////////////////////////////////////////
// FJHS_DRAW: display top-10 scores (text only — no sprites on PET)
FJHS_NL: .byte $0D, 0
