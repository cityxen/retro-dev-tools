...
if target=="C64":
    if emulator=="Default":
        ...
        if OS_DETECTED=="LINUX":
            emulator=VICE_PATH+os.path.sep+"x64"
...
if target=="C128":
    if emulator=="Default":
        ...
        if OS_DETECTED=="LINUX":
            emulator=VICE_PATH+os.path.sep+"x128"
...
if target=="VIC20":
    if emulator=="Default":
        ...
        if OS_DETECTED=="LINUX":
            emulator=VICE_PATH+os.path.sep+"xvic"
...
if target=="PET":
    if emulator=="Default":
        ...
        if OS_DETECTED=="LINUX":
            emulator=VICE_PATH+os.path.sep+"xpet"
...
if target=="DTV":
    if emulator=="Default":
        ...
        if OS_DETECTED=="LINUX":
            emulator=VICE_PATH+os.path.sep+"x64dtv"
